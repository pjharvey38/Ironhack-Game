...
quiz[2] = new Question("Cuando acabáis la cena o la comida, ¿quién se levanta primero a recoger los platos?", "Es una tarea que repartimos al cincuenta por ciento, ¡por supuesto!", "La mujer siempre porque ya lo hace por intuición, yo eso es que no lo tengo.", "Pues casi siempre ella y ya la intento ayudar cuando puedo.");
quiz[3] = new Question("En la primera cita con una chica, ¿quién paga la cena?", "Lo dividimos equitativamente entre los dos, a no ser que ella se pida un entrecot y yo una ensalada...", "Hombre, vaya pregunta! Yo soy todo un caballero, por supuesto que pago yo.", "Pues si quiero tener más posibilidades esa noche, tendré que pagar yo.");
quiz[4] = new Question("¿Quién pone las lavadoras en tu casa?", "Depende de quien llegue antes, pero es algo que hacemos los dos.", "Yo es que a mi eso no se da nada bien, mejor que lo haga la mujer que tiene más delicadeza para esas cosas.", "A cada uno lo suyo, yo cualgo los cuadros y ella se encarga de las lavadoras, ¡faltaría más!");
...
quiz[15] = new Question("¿Has criticado alguna vez a una mujer por haber tenido demasiadas parejas sexuales?", "Pues sí, pero ahora que lo dices me doy cuenta de que es muy machista.", "Hombre no es lo mismo una mujer que un hombre, los hombres tienen mucha más necesidad sexuale que las mujeres.", "Claro, una mujer decente solo debería estar con un hombre y dedicarse a su casa y familia.");
quiz[16] = new Question("Cuando silbas a una chica por la calle, lo haces por...", "Para demostrar ante el resto de chicos lo hombre que soy", "Porque soy un romántico empedernido y sé que a las mujeres les encanta", "Un buen cumplido no le sienta mal a nadie, no?");
quiz[17] = new Question("¡Todas las mujeres sois unas exageradas!", "No es cierto, es una de las respuestas por defecto del patriarcado para desacreditar la opinión de una mujer", "Y si ya le sumas la regla, son unas inestables insufribles", "Totalmente de acuerdo, los hombres somos mucho más racionales y estables que cualquier mujer.");
